...
class Scatter extends Component {
  ...
  makeStepOption = (option, data, centroids) => {
      ...
      series: [
        {
          ...
          renderItem: this.renderItemPoint,
          data: data
        },
        {
          type: 'custom',
  ...
  getOption = () => {
    ...
    this.makeStepOption(option, originalData);
  ...
  componentDidMount() {
    let chartDom = document.getElementById("scatterMain");
  ...
  render() {
    return (
      <div className={style.scatterContainer}>
